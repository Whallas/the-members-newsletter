 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Topic> $myTopics
 * @property-read int|null $my_topics_count
...
{
    use HasApiTokens, HasFactory, Notifiable, HasRoleLevels;
    ...
    {
        return $this->belongsToMany(Role::class, 'role_user', 'user_id', 'role')
    ...
    {
        return $this->hasMany(TopicMessage::class, 'sender_id');
    }
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany|\App\Models\Topic
     */
